# Python3 program for implementation of FCFS  scheduling with different arrival time
...
def findWaitingTime(processes, n, bt, wt, at):
    ...
    for i in range(1, n):
        ...
        # If waiting time for a process is in  negative that means it is already
